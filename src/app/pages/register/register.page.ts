...
export class RegisterPage implements OnInit, OnDestroy {
  ...
  constructor(private formBuilder: FormBuilder, private store: Store<AppState>,
    private toastController: ToastController, /*private locationServices: LocationService*/) { }
  ...
  /*private fillUserAddressWithUserCurrentPosition() {
    this.geolocation.getCurrentPosition().then(position => {
      this.locationServices.geocode(position.coords).subscribe(results => {
        this.registerForm.setAddress(results);
      });
    })
  }*/
